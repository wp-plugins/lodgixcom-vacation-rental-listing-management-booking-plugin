...
.lodgix_check_availability_icon {
    background:url("__PLUGIN_FOLDER__images/Lodgix200x50.png") no-repeat scroll center center transparent;
    width: 200px;
    height: 50px;
    text-decoration: none;
    display: inline-block;
...
.lodgix_map_icon {
    background:url("__PLUGIN_FOLDER__images/map_50.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    text-decoration: none;
    display: inline-block;
...
.lodgix_email_icon {
    background:url("__PLUGIN_FOLDER__images/mail_50.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
...
.lodgix_view_icon {
    background:url("__PLUGIN_FOLDER__images/kappfinder_50.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    text-decoration: none;
    display: inline-block;
...
.lodgix_video_icon {
    background:url("__PLUGIN_FOLDER__images/video_icon.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    text-decoration: none;
    display: inline-block;
...
.lodgix_virtual_tour_icon {
    background:url("__PLUGIN_FOLDER__images/virtual_tour.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    background-size:50px 50px;
    text-decoration: none;
...
#lodgix_no_pets_icon {
   background:url("__PLUGIN_FOLDER__images/no_pets.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    background-size:50px 50px;
    text-decoration: none;
...
#lodgix_no_smoke_icon {
   background:url("__PLUGIN_FOLDER__images/no_smoke.png") no-repeat scroll center center transparent;
    width: 50px;
    height: 50px;
    background-size:50px 50px;
    text-decoration: none;
