...
(function($)
{
    function RoyalSlider(element, options)
        {
            ...
            this._upEvent = "";
            var self = this;
            this.settings = jQueryLodgix.extend(
            {}, jQueryLodgix.fn.royalSlider.defaults, options);
            ...
            if (jQueryLodgix.browser.msie && parseInt(jQueryLodgix.browser.version, 10) <= 8)
            {
                this._isIE8 = true;
            }
            else
    ...
    RoyalSlider.prototype = {
            ...
            if (!this.isAnimating)
            {
                ...
                if (fromTouch || silent || this.settings.slideTransitionType === "move")
                {
                    ...
                    if (!this._useWebkitTransition)
                    {
                        if (parseInt(this._dragContainer.css("left"), 10) !== -this.currentSlideId * this.slideWidth)
                        {
                            ...
                            {
                                left: -this.currentSlideId * this.slideWidth
                            }, slideAnimSpeed, (customSpeed > 0 ? "easeOutSine" : this.settings.slideTransitionEasing), function()
                            {
                ...
                else
                {
                    ...
                    if (!this._animateCSS3Opacity)
                    {
                        ...
                        {
                            opacity: 0
                        }, slideAnimSpeed, this.settings.slideTransitionEasing, function()
                        {
                            newSlide.remove();
                            self._onSlideAnimationComplete();
                        });
        ...
        updateSliderSize: function()
        {
            ...
            {
                this.sliderWidth = newWidth || 640;
                this.sliderHeight = newHeight || 480;
        ...
        _onDragMove: function(e)
        {
            ...
            if (distance != 0)
            {
                ...
                else
                {
                    this._dragContainer.css(
                    {
                        '-webkit-transform': 'translate3d(' + (this._tx + distance) + 'px, 0, 0)'
                    });
                }
            }
                ...
                for (var i = 0; i < captionItems.length; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (moveEnabled)
                        {
                            ...
                            cssObj["-webkit-transform"] = "translate3d(" + (isNaN(newEffectObj["margin-left"]) ? 0 : (newEffectObj["margin-left"] + "px")) + ", " + (isNaN(newEffectObj["margin-top"]) ? 0 : (newEffectObj["margin-top"] + "px")) + ",0)";
                    ...
                    this._captionAnimateTimeouts.push(setTimeout((function(cItem, animateData, cSpeed, cEasing, cId, objFadeEnabled, objMoveEnabled)
                    {
                        return function()
                        {
                            ...
                            else
                            {
                                cItem.css(
                                {
                                    '-webkit-transition-duration': (cSpeed + "ms"),
    ...
    jQueryLodgix.fn.royalSlider = function(options)
    {
    ...
    jQueryLodgix.fn.royalSlider.defaults = {
        ...
        disableTranslate3d: true, // Disables CSS3 transforms on touch devices
    ...
    jQueryLodgix.fn.royalSlider.settings = {};
})(jQueryLodgix);