...
(function($) {
	...
	function RoyalSlider(element, options) {
		...
		this.settings = jQueryLodgix.extend({}, jQueryLodgix.fn.royalSlider.defaults, options);
		...
		setTimeout(function() { self.updateSliderSize(); }, 0);	
				...
				if(imgAlignCenter || imgScaleMode == "fill" || imgScaleMode == "fit") {			
					...
					function scaleImg () {						
						...
						_tempImg.onload = function() {
							...
							if (imgAlignCenter) {            		
								img.css({"margin-left": Math.floor((containerWidth - nWidth) / 2)});
								img.css({"margin-top":Math.floor((containerHeight - nHeight) / 2)});            		
							}  
						};
